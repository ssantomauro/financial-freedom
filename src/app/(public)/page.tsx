...
import { Calculator, TrendingUp, Home, Baby, PiggyBank, Target, ArrowRight, CheckCircle } from 'lucide-react'
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="space-y-6">
                  <BenefitItem
                      title="100% Free"
                      description="Unlimited calculations on all calculators, completely free."
                  />
                  <BenefitItem
        ...
        <section className="py-20 px-4 bg-blue-600 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-blue-100">
              Free forever. Get instant access to all calculators.
            </p>
            <Link
                href="/signup"
